...
public class EcoLifeRpcCall {
     ...
     * @return 结果
     */
    public static String queryDish() {
        String args = "[{\"channel\":\"ALIPAY\"}]";
        return ApplicationHook.requestString("alipay.ecolife.rpc.h5.queryDish", args);
    }
    ...
    /*放心消费能量*/
    public static String easeConsumeGenerateEnergy(String uid) {
        return ApplicationHook.requestString("com.alipay.rcshield.facade.easeconsume.generateenergy",
                "[{\"tapCode\":\"nw00y4gc8j0z\",\"uid\":\""+uid+"\"}]");
    }
}
