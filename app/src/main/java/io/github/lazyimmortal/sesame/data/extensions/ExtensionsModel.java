...
import io.github.lazyimmortal.sesame.model.extensions.answerAI.AnswerAIExtension;
import io.github.lazyimmortal.sesame.model.extensions.antForest.AntForestExtension;
import io.github.lazyimmortal.sesame.model.extensions.antForest.FetchRanking;
import io.github.lazyimmortal.sesame.model.extensions.antSports.AntSportsExtension;
import io.github.lazyimmortal.sesame.model.extensions.backupRestore.BackupRestore;
import io.github.lazyimmortal.sesame.model.extensions.logModel.LogModel;
import io.github.lazyimmortal.sesame.model.extensions.messagePush.MessagePush;
import io.github.lazyimmortal.sesame.model.extensions.request.RequestModel;
...
public class ExtensionsModel {
    ...
    private static final List<Class<? extends Model>> modelClazzList = new ArrayList<>();

    static {
        modelClazzList.add(LogModel.class);
        modelClazzList.add(AntForestExtension.class);
        modelClazzList.add(FetchRanking.class);
        modelClazzList.add(AntSportsExtension.class);
        modelClazzList.add(AnswerAIExtension.class);
        modelClazzList.add(BackupRestore.class);
        modelClazzList.add(MessagePush.class);
        modelClazzList.add(RequestModel.class);
    }
