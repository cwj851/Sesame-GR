...
public class AntSportsRpcCall {
    ...
    public static String queryPathName(String pathId) {
        try {
            ...
            if (MessageUtil.checkResponse("queryPathName", jo)) {
    ...
    public static String walkGo(String date, String pathId, int useStepCount) {
        String args = "[{\"apiVersion\":\"energy\",\"appId\":\"2019072565980504\",\"date\":\""+date+"\",\"pathId\":\""+pathId+"\",\"source\":\"ch_qianghaoyou_zouluxian\",\"timeZone\":\"Asia/Shanghai\",\"useStepCount\":"+useStepCount+"}]";
